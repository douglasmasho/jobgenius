...
function Home() {
  ...
  const [messages, setMessages] = useState([
    {
      message: "Hi, my name is JobGenius. I am here to help you decide what career fits you best based on your interests, skills, aptitude and personality. I will ask you a series of 10 questions to get to know you better. After these 10 questions I will recommend 3 jobs each with their match to your personality. Say hi to get started :)",
      sender: "JobGenius",
      direction: "incoming"
    }
  ]);
